...
namespace Hazel {
	...
	Hazel::RenderCommandQueue::RenderCommandQueue()
	{
	...
	void Hazel::RenderCommandQueue::Submit(const RenderCommand& command)
	{
	...
	void Hazel::RenderCommandQueue::SubmitCommand(RenderCommandFn fn, void* params, unsigned int size)
	{
